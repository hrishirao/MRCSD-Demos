...
import sys,linecache, threading, time, serial, puz ,inflect,pygame
...
ser = serial.Serial("/dev/tty.usbmodem146101", baudrate="9600",timeout=0.001)
tempframe=bytearray([])
    ...
    for x in range(1,41):
        ...
        if(x==2 or x==34):
            ...
            for element in answersheet[x/2-side_buffer]:
                if (element == 'Blank'):row_frame = row_frame +bytearray([chr(empty),0x00,chr(bg),0x00])
                    ...
                    if (current_direction =="A"):
                        ...
                        if(d==1 and a ==0):
                            ...
                            for i in range (0,int(leng_a)):
                                ...
                                print current_row+i
                                print "-------"
                                if(answersheet[current_row-1][current_col-1 + i] != "Blank"):
                            ...
                            if( word!='Blank'):system("say ' "+word + "' -r "+str(v_speed)  )
                        ...
                        if (a==1 and d==0):
                            ...
                            for i in range (0,int(leng_d)):
                                ...
                                print current_row+i
                                print "-------"
                                if(answersheet[current_row-1 + i][current_col-1] != "Blank"):
                ...
                if(edit_mode==0 and ord(button_value[2]) ==8):
                    ...
                    try :
                        ...
                        if (character != "backspace"):
                            ...
                            if(current_direction == "A"):char_row = ((cursor_row)/2)-2;char_col = ((cursor_col)/2)-2
                            if(current_direction == "D"):char_row = ((cursor_row)/2)-2;char_col = ((cursor_col)/2)-2
                            answersheet[char_row][char_col] = "Blank"
