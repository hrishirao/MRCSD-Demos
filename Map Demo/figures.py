...
def plot_line(ax, ob, color=GRAY, zorder=1, linewidth=3, alpha=1, label = None):
    x, y = ob.xy
    ax.plot(x, y, color=color, linewidth=linewidth, solid_capstyle='round', zorder=zorder, alpha=alpha, label = label)
